...
|:-|:-|:-|:-|:-|
|1|[alibaba/p3c](https://gitee.com/alibaba/p3c)|Alibaba Java Coding Guidelines pmd implements and IDE plugin|26680|2021-12-27|
|2|[Tamsiree/RxTool](https://gitee.com/Tamsiree/RxTool)|Android开发人员不得不收集的工具类集合   支付宝支付   微信支付（统一下单）   微信分享   Zip4j压缩（支持分卷压缩与加密）   一键集成UCrop选择圆形头像   一键集成二维码和条形码的扫描与生成   常用Dialog   WebView的封装可播放视频   仿斗鱼滑动验证码   Toast封装   震动   GPS   Location定位   图片缩放   Exif 图片 ...|11585|2021-12-27|
...
|24|[DylanCaiCoding/Longan](https://gitee.com/DylanCaiCoding/Longan)|A collection of Kotlin utils which makes Android application development faster and easier. (让 Android 开发更简单的 Kotlin 工具类集合)|176|2021-12-29|
|25|[m-i-n-a-r/birday](https://gitee.com/m-i-n-a-r/birday)|🎉 A beautiful Kotlin app to remember birthdays and events without having to open Facebook, set alarms or rely on Google Calendar.|154|2022-01-01|
